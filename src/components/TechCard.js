  ...
  return (  
    <div className="card card-tc">
      <div className="card-body text-center py-4">
        ...
        <p className="card-text mx-1 text-muted d-lg-block mb-4">{textOne}</p>
        <h5 className="card-title">{titleTwo}</h5>
        <p className="card-text mx-2 my-0 text-muted d-lg-block">{itemOne}</p>
        <p className="card-text mx-2 my-0 text-muted d-lg-block">{itemTwo}</p>
        <p className="card-text mx-2 my-0 text-muted d-lg-block">{itemThree}</p>
        <p className="card-text mx-2 my-0 text-muted d-lg-block">{itemFour}</p>
        {/* style={{width: '300px'}} */}
